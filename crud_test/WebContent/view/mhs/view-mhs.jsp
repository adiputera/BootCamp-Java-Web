	...
	<div id="container">
		...
		<div id="content">
			<div id="isi-content">
				...
				<%
					List<Mahasiswa> list = MahasiswaService.read();
					//foreach
				%>
				<table border="1" width=100%>
					...
					<tr>
						<%
							for (Mahasiswa e : list) {
								out.print("<tr><td>" + e.getNim() + "</td><td>" + e.getNama() + "</td><td>" + e.getAlamat() + "</td><td>"
										+ e.getUniv() + "</td><td><a style='color:white;' href='edit-mhs.jsp?nim="+e.getNim()+"'>edit</td>" + "<td><a style='color:white;' href='MhsDel?nim="+e.getNim()+"'>delete</a></td></tr>");
							}
						%>
					</tr>
				</table>
				<a href="add-mhs.jsp" style="color:white;">Tambah Data</a>
			</div>
		</div>
		<!--end content-->
		<div id="nav"></div>
